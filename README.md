...
- Natural post-call context, live preview, mobile number, Mermaid-rendered architecture, repository, and note
...
Working now: multilingual calls, contextual WhatsApp, callback scheduling, and verified Vercel previews. Next: move delivery to Meta Cloud API and connect production CRM orchestration.
